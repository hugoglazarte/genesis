...
echo'<div class="wrap"><div class="nav-top-nuevo">';
wp_nav_menu( array( 'theme_location' => 'third-menu', 'container_class' => 'genesis-nav-menu' ) );
echo'</div></div>';
}

// widget area en top bar para el datos
genesis_register_sidebar( array(
'id' => 'topbar-info',
'name' => __( 'Topbar Info', 'themename' ),
'description' => __( 'This is the topbar info section', 'themename' ),
));

add_action( 'genesis_before', 'sp_before_topbar_widget' );

	function sp_before_topbar_widget() {

		genesis_widget_area( 'topbar-info', array(
			'before' => '<div class="social-area">',
			'after' => '</div>',
	) );
...
// Widget areas para el home
genesis_register_sidebar( array(
'id' => 'home-slider',
'name' => __( 'Home Slider', 'themename' ),
'description' => __( 'This is the homepage slider section', 'themename' ),
));
